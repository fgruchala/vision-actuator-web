(function () {
    ...
    dashboardController.$inject = ['$log', '$rootScope', '$translate', '$mdToast', '$mdDialog', 'actuatorService'];

    function dashboardController($log, $rootScope, $translate, $mdToast, $mdDialog, actuatorService) {
        var vm = this;
        var loadingPromise;
